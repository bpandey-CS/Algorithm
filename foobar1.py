...
def answer(area):
    global list_of_areas
    if not area:
        return list_of_areas
    largest_possible_area = int(area ** 0.5)**2
    list_of_areas.append(largest_possible_area)
    return answer(area - largest_possible_area)

if __name__ == "__main__":
    total_area = int(input())
    print(answer(total_area))
